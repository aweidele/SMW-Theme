...
endwhile; endif; wp_reset_query(); ?>
  ...
  <section id="searchProjects">
    <h1 class="results" style="margin-bottom: 1em;">Search results for “<?php echo get_search_query(); ?>”</h1>
	<h1 class="no-results" style="margin-bottom: 1em;">No search results found for “<?php echo get_search_query(); ?>”</h1>


<?php /***************************** PROJECTS RESULTS ****************************/ ?>
<?php if(isset($results['projects']) && sizeof($results['projects'])) { ?>
    
    <h3 class="search-results-section-title">Projects <?php if ( 'projects' == get_post_type() ){?><a href="<?php echo get_home_url(); ?>/projects">&laquo; Back to Projects</a><?php } else { ?><a href="javascript:history.back()">&laquo; Back</a><?php } ?></h2>
...
<?php if(isset($results['post']) && sizeof($results['post'])) { ?>
    <h3 class="search-results-section-title">News & Knowledge <?php if ( 'post' == get_post_type() ){?><a href="<?php echo get_home_url(); ?>/news">&laquo; Back to News & Knowledge</a><?php } ?></h2>
    <div class="search-results-section">
