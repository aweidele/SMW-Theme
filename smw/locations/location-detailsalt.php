...
<?php } ?>
	              <p><a href="tel:<?php echo get_field('phone',$office_leader->ID); ?>">+<?php echo str_replace('-',' ',get_field('phone',$office_leader->ID)); ?></a></p>
	              <ul class="leadershipContact">
	                <li class="email"><a href="mailto:<?php echo get_field('email',$office_leader->ID); ?>"><span><?php echo get_field('email',$office_leader->ID); ?></span></a></li>
	                <li class="linkedin"><a href="<?php echo get_field('linkedin',$office_leader->ID); ?>" target="_blank"><span><?php echo get_field('linkedin',$office_leader->ID); ?></span></a></li>
	              </ul>
        	</div>
        </div>
<?php } ?>
	...
	<div class="locationRelated">
		...
		<?php
		$related_projects = get_field('related_projects',$locationPost->ID);
		 if(is_array($related_projects) && sizeof($related_projects)) { ?>
